...
function Core() {
  return (
    <div className='main-div'>
        <h1 className='head'>Our Core <span className='span'>Values</span></h1>
         <div className='line'>
         <hr />
         </div>
        <div className="three">
            ...
            <div className="third">
                ...
                <p className='para'>The master builder of human happiness no one rejects, dislikes, avoids pleasure itself, because it is pleasure extremely.</p>
            </div>
